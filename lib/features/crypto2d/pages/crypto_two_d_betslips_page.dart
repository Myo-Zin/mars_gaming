...
import '../../2d/providers/providers.dart';
...
class _CashInHistoryPageState extends ConsumerState<CryptoTwoDBetSlipsPage> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(cryptoTwoDBetSlipsController);
    return Scaffold(
      appBar: AppBar(
        title: Text("Crypto ${AppLocalizations.of(context).twodSlips}"),
        centerTitle: true,
      ),
      body: Padding(
