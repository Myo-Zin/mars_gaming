class TwoDBetSlipHistoryResponse {
  int? status;
  String? message;
  List<BetSlip>? data;

  TwoDBetSlipHistoryResponse({this.status, this.message, this.data});

  TwoDBetSlipHistoryResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class BetSlip {
  ...
  BetSlip.fromJson(Map<String, dynamic> json) {
    ...
    if (json['bettings'] != null) {
      bettings = <Betting>[];
      json['bettings'].forEach((v) {
