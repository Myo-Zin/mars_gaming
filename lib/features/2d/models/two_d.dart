...
/// map format for betting to send server api 
  ...
  @override
  String toString() {
    return 'TwoDigit(id: $id, betNumber: $betNumber, defaultAmount: $defaultAmount, totalAmount: $totalAmount, hotAmount: $hotAmount, betAmount: $betAmount, block: $block,odd: $odd,section $section, isSelected: $isSelected, isGetExpectedAmount: $isGetExpectedAmount)';
  }
}
